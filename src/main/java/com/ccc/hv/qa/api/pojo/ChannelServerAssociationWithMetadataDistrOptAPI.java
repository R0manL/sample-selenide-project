...
@Getter
@SuperBuilder
public class ChannelServerAssociationWithMetadataDistrOptAPI extends ChannelServerAssociationAPI{
    private final boolean groupOnixFeeds;
    private final boolean metadataParasite;
}
